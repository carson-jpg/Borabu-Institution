        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-shrink-0 flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900 leading-tight">Borabu Technical Training Institute</h1>
                <p className="text-sm text-gray-500 leading-tight">Student Portal</p>
              </div>
            </div>
          </div>
